<?php
	...
	if(mysqli_num_rows($result)<>0) // co du lieu
	{
		echo"<table align='center'>";
			echo"<tr >";
				echo"<td colspan='4' style='background-image:url(../images/danhmuc.png)' height='30'><p style='color:#FFF; font-weight:bold ;text-align:center' align='center'>Sách Mới Nhất</p></td>";
			echo"</tr>";
			$stt=0;
